...
function Home() {
  return (
    <section className="relative !h-[100vh] text-white p-l-16 pt-0 " id="home">
      ...
      {/* Main Content */}
      <div className="ml-28 flex flex-col justify-evenly h-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 ">
          <div className="flex flex-col items-center justify-center text-center h-full gap-16">
            ...
            {/* Stats */}
            <div className="mt-0 grid grid-cols-2 pr-20 w-full  text-center orbitron">
              <div>
